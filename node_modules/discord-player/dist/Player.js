        ...
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            ...
            switch (qt) {
                ...
                case types_1.QueryType.SPOTIFY_SONG: {
                    ...
                    const spotifyData1 = yield spotify_url_info_1.default.getPreview(query).catch(Util_1.Util.noop);
                    if (!spotifyData)
                        return { playlist: null, tracks: [] };
                    const spotifyTrack = new Track_1.default(this, {
                        ...
                        thumbnail: (_r = (_q = spotifyData1.image) === null || _q === void 0 ? void 0 : _q) !== null && _r !== void 0 ? _r : "https://www.scdn.co/i/_global/twitter_card-default.jpg",
